...
def create_keyboard(response):
    ...
    if response == 'начать':
        ...
        keyboard.add_button('Найти соседа(ку), для аренды жилья', color=VkKeyboardColor.PRIMARY)

    elif response == 'найти соседа(ку), для аренды жилья':  # закрытие клавиатуры
            ...
            if event.from_user and not event.from_me:
                ...
                if response == "начать":
                    ...
                    send_message(vk_session, 'user_id', event.user_id,
                                 message='Добро пожаловать в "Аренда бот"', keyboard=keyboard)
                    send_message(vk_session, 'user_id', event.user_id, message= 'Нажмите нужную кнопку для продолжения.\n'
                                                                                'Для того чтобы найти соседа(ку), для совместной \n'
                                                                                'аренды жилья, нажмите "Найти соседа(ку), для '
                                                                                'аренды жилья".',keyboard=keyboard)

                elif response == "найти соседа(ку), для аренды жилья": #создание анкеты
                    '''переход на страницу заполнения обьявления'''
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'Кого вы ищете в качестве соседа(ки)? \n'
                                                                               'Расскажите немного о себе. \n'
                                                                               'Что вы снимаете или планируете \n'
                                                                               'совместно арендовать? \n'
                                                                               'На какой рассчитываете бюджет в месяц, с человека?'
                                 ,keyboard=keyboard)
                    ...
                    '''переход на страницу заполнения обьявления'''
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'За какую цену Вы хотите снять комнату? \n'
                                                                               'Расскажите кто будет снимать комнату? \n'
                                                                               'Какой район предпочтительно? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    ...
                    '''переход на страницу заполнения обьявления'''
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'За какую цену Вы хотите сдать комнату? \n'
                                                                               'Расскажите по какому адресу находится комната? \n'
                                                                               'Опишите комнату и условия проживания? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    #ниже будет функция для заполнения текста объявления.
                    ...
                    '''переход на страницу заполнения обьявления'''
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'Опишите какую Вы хотите снять квартиру? \n'
                                                                               'За какую цену Вы хотите снять 1-комнатную квартиру? \n'
                                                                               'Расскажите кто будет снимать? \n'
                                                                               'Какой район предпочтительно? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    #ниже будет функция для заполнения текста объявления.
                    ...
                    '''переход на страницу заполнения обьявления'''
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'Опишите какую Вы хотите сдать квартиру? \n'
                                                                               'За какую цену Вы хотите сдать 1-комнатную квартиру? \n'
                                                                               'Какой район и адрес? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    #ниже будет функция для заполнения текста объявления.
                    ...
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'Опишите какую Вы хотите снять квартиру? \n'
                                                                               'За какую цену Вы хотите снять 2-комнатную квартиру? \n'
                                                                               'Расскажите кто будет снимать? \n'
                                                                               'Какой район предпочтительно? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    ...
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'Опишите какую Вы хотите сдать квартиру? \n'
                                                                               'За какую цену Вы хотите сдать 2-комнатную квартиру? \n'
                                                                               'Какой район и адрес? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    #ниже будет функция для заполнения текста объявления.
                    ...
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'Опишите какую Вы хотите снять квартиру? \n'
                                                                               'За какую цену Вы хотите снять 3-комнатную квартиру? \n'
                                                                               'Расскажите кто будет снимать? \n'
                                                                               'Какой район предпочтительно? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    ...
                    send_message(vk_session, 'user_id', event.user_id, message='Напишите текст объявления в одном сообщении. \n'
                                                                               'Опишите какую Вы хотите сдать квартиру? \n'
                                                                               'За какую цену Вы хотите сдать 3-комнатную квартиру? \n'
                                                                               'Какой район и адрес? \n'
                                                                               'При желании напишите свой телефон. \n'
                                 ,keyboard=keyboard)
                    #ниже будет функция для заполнения текста объявления.
